...
organized by [ODSC](https://india.odsc.com/).
...
``` r
newProject <- usethis::use_course('https://github.com/jaredlander/ODSCIndia2018/archive/master.zip')
```
...
ODSCIndia2018. You can see this in the top right of RStudio (the name in
